...
import { createCase } from "../../../../actions/Services/ST1010/CaseActions";
...
function FormCreation() {
  ...
  const caseCreate = useSelector((state) => state.ST1010["caseCreate"]);
                    ...
                    <Grid item xs={8} container spacing={2}>
                      ...
                      <Grid item md={6} s={12} xs={12}>
                        <TextField
                          ...
                          variant="outlined"
                          onChange={(event) =>
                            setDoctorSender(event.target.value)
                          }
                        />
                      </Grid>
                    </Grid>
                            ...
                            return (
                              <React.Fragment>
                                ...
                                <div className="btn-box">
                                  ...
                                  {blockNumberList.length - 1 === index && (
                                    <Button
                            ...
                            return (
                              <React.Fragment>
                                ...
                                <div className="btn-box">
                                  ...
                                  {slideNumberList.length - 1 === index && (
                                    <Button
